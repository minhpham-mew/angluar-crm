...
import { meetingsAdapter, MeetingsEntityState } from './meetings.reducer';
...
export const selectMeetingById = (id: string) =>
  createSelector(selectMeetingEntities, (entities) => entities[id]);
...
export const selectTodaysMeetings = createSelector(selectAllMeetings, (meetings) => {
