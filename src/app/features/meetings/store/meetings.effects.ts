...
export class MeetingsEffects {
  ...
  loadMeetings$ = createEffect(() =>
    this.actions$.pipe(
      ...
      exhaustMap(([action, tenantId]) => {
        ...
        return this.appwriteService.getMeetings(tenantId).then(
          (meetings) => MeetingsActions.loadMeetingsSuccess({ meetings })
        ).catch(
          (error) => MeetingsActions.loadMeetingsFailure({ error: error.message })
        );
      })
    )
  );
  ...
  createMeeting$ = createEffect(() =>
    this.actions$.pipe(
      ...
      exhaustMap(({ meeting }) =>
        this.appwriteService.createMeeting(meeting).then(
          (newMeeting) => MeetingsActions.createMeetingSuccess({ meeting: newMeeting })
        ).catch(
          (error) => MeetingsActions.createMeetingFailure({ error: error.message })
        )
      )
    )
  );
  ...
  updateMeeting$ = createEffect(() =>
    this.actions$.pipe(
      ...
      exhaustMap(({ id, changes }) =>
        this.appwriteService.updateMeeting(id, changes).then(
          (meeting) => MeetingsActions.updateMeetingSuccess({ meeting })
        ).catch(
          (error) => MeetingsActions.updateMeetingFailure({ error: error.message })
        )
      )
    )
  );
  ...
  deleteMeeting$ = createEffect(() =>
    this.actions$.pipe(
      ...
      exhaustMap(({ id }) =>
        this.appwriteService.deleteMeeting(id).then(
          () => MeetingsActions.deleteMeetingSuccess({ id })
        ).catch(
          (error) => MeetingsActions.deleteMeetingFailure({ error: error.message })
        )
      )
    )
  );
