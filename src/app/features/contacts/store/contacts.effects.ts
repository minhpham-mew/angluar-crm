...
export class ContactsEffects {
  ...
  loadContacts$ = createEffect(() =>
    this.actions$.pipe(
      ...
      exhaustMap(([action, tenantId]) => {
        ...
        return this.appwriteService.getContacts(tenantId).then(
          (contacts) => ContactsActions.loadContactsSuccess({ contacts })
        ).catch(
          (error) => ContactsActions.loadContactsFailure({ error: error.message })
        );
      })
    )
  );
  ...
  createContact$ = createEffect(() =>
    this.actions$.pipe(
      ...
      exhaustMap(({ contact }) =>
        this.appwriteService.createContact(contact).then(
          (newContact) => ContactsActions.createContactSuccess({ contact: newContact })
        ).catch(
          (error) => ContactsActions.createContactFailure({ error: error.message })
        )
      )
    )
  );
  ...
  updateContact$ = createEffect(() =>
    this.actions$.pipe(
      ...
      exhaustMap(({ id, changes }) =>
        this.appwriteService.updateContact(id, changes).then(
          (contact) => ContactsActions.updateContactSuccess({ contact })
        ).catch(
          (error) => ContactsActions.updateContactFailure({ error: error.message })
        )
      )
    )
  );
  ...
  deleteContact$ = createEffect(() =>
    this.actions$.pipe(
      ...
      exhaustMap(({ id }) =>
        this.appwriteService.deleteContact(id).then(
          () => ContactsActions.deleteContactSuccess({ id })
        ).catch(
          (error) => ContactsActions.deleteContactFailure({ error: error.message })
        )
      )
    )
  );
