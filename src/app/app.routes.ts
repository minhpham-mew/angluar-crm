...
export const routes: Routes = [
  ...
  },
  {
    path: 'signup',
    loadComponent: () =>
      import('./auth/components/signup/signup.component').then((c) => c.SignupComponent),
  },
  {
    path: 'dashboard',
    loadComponent: () =>
    ...
    children: [
      {
        ...
        loadComponent: () =>
          import(
            './shared/components/dashboard/dashboard-overview/dashboard-overview.component'
      ...
      },
      {
        path: 'deals',
        loadComponent: () =>
          import('./features/deals/components/deals-list/deals-list.component').then(
